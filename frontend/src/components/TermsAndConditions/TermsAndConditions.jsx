  ...
  return (
    <section id="termsandcond">
      ...
      <div className="content">
        <p>
          Welcome to LAVISH VILLAS. Please read these terms and conditions
        ...
        <ul>
          ...
          <li>
            ...
            <ol>
              <li>
                ...
                graphics, logos, images, and software, is the property of LAVISH VILLAS
          ...
          <li>
            ...
            <p>
              To the fullest extent permitted by applicable law, LAVISH VILLAS
          ...
          <li>
            ...
            <p>
              ...
              <span>lavishvillas@gmail.com</span>.
            </p>
          </li>
        </ul>
        <h3></h3>
